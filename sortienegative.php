...
if(isset($_POST['add']))
{
    ...
    //if($_POST['montantadd'] > $caissesuccursale) 
    //{
    //$verifycaissevalue='1' ;
    //}
    //else
...
if(isset($_POST['modif']))
{
    ...
    //if($_POST['montantmodif'] > $idmontantdetail['montant'] + $caissesuccursale) 
    //{
    ...
    <ul class="nav">
       ...
       <fieldset style="width:180px;text-align:center;margin:0px;padding-bottom:12px;display:inline-block;margin-right:2px;height:70px;">
        <legend>Caisse</legend>
            <li id="filtrec1"><input style="padding:9px;width:150px" name="ste" type="text"  id="country_caisse" onkeyup="autocompletcaisseste();apost('country_caisse')"  autocomplete="off"  <?php if(isset($_POST['ste'])){echo ' value="'.$_POST["ste"].'" ';}elseif(isset($_GET['ste'])){echo ' value="'.$_GET["ste"].'" ';}?>/></li> 
            <ul style="width:164px;color:#333;font-size:15px;margin-left:2px;" id="country_list_caisse"></ul>
        </fieldset>
...
?> 
      ...
      <a href="#" style="padding:5px 10px" id="export" onclick="tableToExcel('testTable', 'W3C Example Table')">Exporter en excel-csv ..</a>
      </div>
      <?php
      }
      ?>
...
<div id="champsleft" style="display:inline-block;margin-left:40px;width:500px" > 
        ...
        ?>
          ...
          <tr>
            ...
            <td style="font-size:16px;text-align:right;padding:10px;padding-right:30px;font-weight:bold">
              <?php echo number_format($familletotal['summantant'], 2, ',', ' ').""; ?>
            </td>
          </tr>
      ...
      <a href="#" style="padding:5px 10px" id="export" onclick="tableToExcel('etatfamilletable', 'W3C Example Table')">Exporter en excel-csv ..</a>
      </div>
      <?php
      }
      ?>
        ...
        <fieldset >
          ...
          <?php
            ...
            while ($ste1 = $req1->fetch())
            {
              ...
              {
              ?> 
              <p id="<?php echo $ste1['id']; ?>" style="margin-top:10px;margin-bottom:15px;display:none">Solde caisse: <span style="color:#00BA84;font-weight:bold"><?php echo number_format( $totalcaisse, 2, ',', ' '); ?> DHs</span> </p>
...
function soldecaisse(val)
{
   var soldecaisse = val.value;
          ...
          <?php
            ...
            while ($ste1 = $req1->fetch())
            {
              ...
              ?> 
                ...
                document.getElementById(<?php echo $ste1['id']; ?>).style.display = "none";
    ...
    document.getElementById(soldecaisse).style.display = "block";
}
